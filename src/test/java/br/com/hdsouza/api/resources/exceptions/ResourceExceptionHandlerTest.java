package br.com.hdsouza.api.resources.exceptions;

import br.com.hdsouza.api.services.exceptions.DataIntegrityViolationException;
...
class ResourceExceptionHandlerTest {
    ...
    public static final String OBJETO_NAO_ENCONTADO = "Objeto não encontado";
    ...
    void whenObjectNotFoundExceptionThenReturnAResponseEntity() {
        ResponseEntity<StandardError> response = exceptionHandler.objectNotFound(
                new ObjectNotFoundException(OBJETO_NAO_ENCONTADO),
        ...
        assertEquals(OBJETO_NAO_ENCONTADO, response.getBody().getError());
